...
default['dirs']['icloud_hold_dir']     = "#{node['dirs']['icloud_hold_dir']}/Mobile\ Documents/com~apple~CloudDocs/Hold"
default['dirs']['icloud_app_data_dir'] = "#{node['dirs']['icloud_dir']}/Hold/app_data"
